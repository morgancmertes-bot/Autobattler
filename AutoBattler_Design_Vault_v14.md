# Auto Battler — Design Vault v5
**Internal version: v5 | GitHub filename: AutoBattler_Design_Vault_v14.md**  
**Last updated: 2026-03-07**  
**Status: AUTHORITATIVE — all buildings fully designed as of this version**
**Last Updated:** 2026-03-07  
**Status:** v4 — Adds fully documented combat system (crit, parry, block, knockback), complete hit resolution chain, GML pseudocode for all systems, unit polish patch notes (Hatchling line, tower attack types)  
